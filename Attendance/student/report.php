  ...
  <div class="form-group">
   ...
   <?php
    ...
    //  $count_tot = mysql_num_rows($all_query);
     ...
     <tbody style="margin-top:-130px;">
     

      <tr>
        <td>Total Class (Days) </td>
        <td><span style="margin-left:15px"><?php echo $count_tot; ?></span> </td>
      </tr>

      <tr>
        <td>Present (Days) </td>
        <td><span style='margin-left: 15px'><?php echo $data[1]; ?></span></td>
      </tr>

      <tr>
        <td>Absent (Days) </td>
        <td><span style="margin-left:15px;"><?php echo $count_tot -  $data[1]; ?></span></td>
      </tr>
